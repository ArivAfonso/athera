...
const CardTopic2: FC<CardTopic2Props> = ({ className = '', topic, index }) => {
    return (
        <Link
            ...
            className={`nc-CardTopic2 relative flex flex-col items-center justify-center text-center px-3 py-5 sm:p-6 bg-neutral-100 dark:bg-neutral-900 rounded-3xl transition-colors ${className}`}
        >
            <div className="mt-3">
