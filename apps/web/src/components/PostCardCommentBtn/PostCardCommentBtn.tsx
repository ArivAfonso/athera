...
const PostCardCommentBtn: FC<PostCardCommentBtnProps> = ({
    ...
    if (isATagOnSingle) {
        return (
            <a
                href={'#comments'}
                className={`nc-PostCardCommentBtn relative items-center min-w-[68px] rounded-full text-neutral-6000 bg-neutral-50 transition-colors dark:text-neutral-200 dark:bg-neutral-800 hover:bg-teal-50 dark:hover:bg-teal-950 hover:text-teal-600 dark:hover:text-teal-500 ${className} `}
                title="Comments"
            >
