...
export const youtubeModal = ({
    ...
    btnResize.innerHTML = Icons['Resize']()
    ...
    function toggleDocumentClickListener() {
        ...
        if (documentClickListener) {
            ...
            documentClickListener = (event) => {
                const mediaResizeGripper =
                    wrapper.previousSibling as HTMLElement
                ...
                if (
                    ...
                    mediaResizeGripper?.classList?.remove(
    ...
    btnResize.addEventListener('click', (event) => {
        ...
        mediaResizeGripper.classList.toggle(
            'hypermultimedia__resize-gripper--active'
        )
