...
export const highlightButton = (
    ...
    const { btnSquareLeft, btnSquareRight, buttonInline, btnSquareCenter } =
        buttons

    ;[btnSquareLeft, btnSquareRight, buttonInline, btnSquareCenter].forEach(
        (btn) => btn.classList.remove(activeClass)
    )
