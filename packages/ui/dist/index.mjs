  ...
  return /* @__PURE__ */ jsxs7(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx8(XMarkIcon, { className: iconSize })
      ]
    }
  );
};
...
var Modal = ({
  ...
  return /* @__PURE__ */ jsxs8("div", { className: `Modal ${containerClassName}`, children: [
    ...
    /* @__PURE__ */ jsx9(Transition2, { appear: true, show: isOpen, as: Fragment4, children: /* @__PURE__ */ jsx9(
      Dialog,
      {
        as: "div",
        ...
        children: /* @__PURE__ */ jsxs8("div", { className: "min-h-screen px-1 text-center md:px-4", children: [
          /* @__PURE__ */ jsx9(
            Transition2.Child,
            {
              ...
              leaveTo: "opacity-0",
              children: /* @__PURE__ */ jsx9(Dialog.Overlay, { className: "fixed inset-0 bg-neutral-900 bg-opacity-50 dark:bg-opacity-80" })
            }
          ),
          /* @__PURE__ */ jsx9(
            "span",
              ...
              children: /* @__PURE__ */ jsxs8(
                "div",
                {
                  ...
                  children: [
                    ...
                    renderFooter && enableFooter && /* @__PURE__ */ jsx9("footer", { className: "flex-shrink-0", children: /* @__PURE__ */ jsx9("div", { className: "py-4 px-6 border-t border-neutral-100 dark:border-neutral-700 md:py-5", children: renderFooter(closeModal) }) })
                  ]
                }
              )
            }
  ...
  return /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx13("span", { className: "wil-avatar__name", children: name[0] })
      ]
    }
  );
};
      ...
      children: /* @__PURE__ */ jsxs11(
        "div",
        {
          ...
          children: [
            ...
            desc && /* @__PURE__ */ jsx14("span", { className: "mt-2 md:mt-3 font-normal block text-base sm:text-xl text-neutral-500 dark:text-neutral-400", children: desc })
          ]
        }
      )
    }
...
var Img = (_a) => {
  ...
  return /* @__PURE__ */ jsx15("div", { className: containerClassName, children: /* @__PURE__ */ jsx15(Image2, __spreadValues({ className, alt, sizes }, args)) });
};
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs12("div", { children: [
          /* @__PURE__ */ jsx17(Label_default, { className: "text-base", children: label }),
          /* @__PURE__ */ jsx17("p", { className: "text-neutral-500 dark:text-neutral-400 text-base", children: desc })
        ] }),
        /* @__PURE__ */ jsxs12(
          Switch,
          {
...
var ButtonPrimary = (props) => {
  return /* @__PURE__ */ jsx18(Button_default, __spreadProps(__spreadValues({}, props), { pattern: "primary" }));
};
...
var ButtonSecondary = (props) => {
  return /* @__PURE__ */ jsx19(Button_default, __spreadProps(__spreadValues({}, props), { pattern: "secondary" }));
};
...
var ButtonThird = (props) => {
  return /* @__PURE__ */ jsx21(Button_default, __spreadProps(__spreadValues({}, props), { pattern: "third" }));
};
...
var Heading2 = (_a) => {
  ...
  return /* @__PURE__ */ jsxs13(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        !!emoji && /* @__PURE__ */ jsx22("span", { className: "mr-4 text-2xl md:text-3xl lg:text-4xl leading-none", children: emoji }),
...
var MyLink = ({
  ...
  return /* @__PURE__ */ jsx23(Link3, { className: `MyLink ${colorClass} ${className}`, href, children });
};
...
var Nav = ({
  ...
  return /* @__PURE__ */ jsx25("nav", { className: `Nav ${containerClassName}`, "data-nc-id": "Nav", children: /* @__PURE__ */ jsx25("ul", { className: `flex  ${className}`, children }) });
};
var Nav_default = Nav;
