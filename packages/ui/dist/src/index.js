...
var Badge = ({
  ...
  const getColorClass2 = (hasHover = true) => {
    switch (color) {
      case "pink":
        return `text-pink-800 bg-pink-100 dark:bg-pink-950 dark:text-pink-100 ${hasHover ? "hover:text-white hover:bg-pink-800 dark:hover:bg-pink-100 dark:hover:text-pink-800" : ""}`;
      case "red":
        return `text-red-800 bg-red-100 dark:bg-red-950 dark:text-red-100 ${hasHover ? "hover:text-white hover:bg-red-800 dark:hover:bg-red-100 dark:hover:text-red-800" : ""}`;
      case "gray":
        return `text-gray-800 bg-gray-100 dark:bg-gray-950 dark:text-gray-100 ${hasHover ? "hover:text-white hover:bg-gray-800 dark:hover:bg-gray-100 dark:hover:text-gray-800" : ""}`;
      case "green":
        return `text-green-800 bg-green-100 dark:bg-green-950 dark:text-green-100 ${hasHover ? "hover:text-white hover:bg-green-800 dark:hover:bg-green-100 dark:hover:text-green-800" : ""}`;
      case "purple":
        return `text-purple-800 bg-purple-100 dark:bg-purple-950 dark:text-purple-100 ${hasHover ? "hover:text-white hover:bg-purple-800 dark:hover:bg-purple-100 dark:hover:text-purple-800" : ""}`;
      case "indigo":
        return `text-indigo-800 bg-indigo-100 dark:bg-indigo-950 dark:text-indigo-100 ${hasHover ? "hover:text-white hover:bg-indigo-800 dark:hover:bg-indigo-100 dark:hover:text-indigo-800" : ""}`;
      case "yellow":
        return `text-yellow-800 bg-yellow-100 dark:bg-yellow-900 dark:text-yellow-100 ${hasHover ? "hover:text-white hover:bg-yellow-800 dark:hover:text-yellow-800 dark:hover:bg-yellow-100" : ""}`;
      case "blue":
        return `text-blue-800 bg-blue-100 dark:bg-blue-950 dark:text-blue-100 ${hasHover ? "hover:text-white hover:bg-blue-800 dark:hover:bg-blue-100 dark:hover:text-blue-800" : ""}`;
      case "orange":
        return `text-orange-800 bg-orange-100 dark:bg-orange-900 dark:text-orange-100 ${hasHover ? "hover:text-white hover:bg-orange-800 dark:hover:bg-orange-100 dark:hover:text-orange-800" : ""}`;
      default:
        return `text-pink-800 bg-pink-100 dark:bg-pink-950 dark:text-pink-100 ${hasHover ? "hover:text-white hover:bg-pink-800 dark:hover:bg-pink-100 dark:hover:text-pink-800" : ""}`;
    }
  };
  const CLASSES = "nc-Badge  inline-flex px-2.5 py-1 rounded-full font-medium text-xs " + className;
  return href ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    import_link.default,
    {
      href,
      className: `transition-colors hover:text-white duration-300 ${CLASSES} ${getColorClass2()}`,
      children: name
    }
  ) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "span",
    {
      className: `transition-colors duration-300 cursor-default ${CLASSES} ${getColorClass2()}`,
      children: name
    }
  );
};
  ...
  if (!!href) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      import_link2.default,
      {
        ...
        type,
        children: [
          loading && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Loading_default, {}),
...
var Checkbox = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: `flex text-sm sm:text-base ${className}`, children: [
    ...
    label && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "label",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: " text-neutral-900 dark:text-neutral-100 line-clamp-1", children: label }),
          subLabel && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "mt-1 text-neutral-500 dark:text-neutral-400 text-sm font-light", children: subLabel })
        ]
      }
    )
  ] });
...
function DropDown({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_react4.Menu, { as: "div", className: "relative inline-block text-left", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_react4.Menu.Button, { className, title, children: renderTrigger ? renderTrigger() : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(import_outline2.EllipsisHorizontalIcon, { className: triggerIconClass }) }),
      ...
      import_react4.Transition,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          import_react4.Menu.Items,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "px-1.5 py-2 text-sm text-neutral-600 dark:text-neutral-300", children: data.map((item) => {
              var _a;
              return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                import_react4.Menu.Item,
                {
                  as: !!item.href ? item.isTargetBlank ? "a" : import_link3.default : "div",
                  href: (_a = item.href) != null ? _a : void 0,
                  onClick: () => onClick(item),
                  "data-menu-item-id": item.id,
                  className: dropdownItemsClass,
                  target: item.isTargetBlank ? "_blank" : void 0,
                  children: () => renderItem && typeof renderItem(item) !== "undefined" ? renderItem(item) : /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
                    !!item.icon && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                      "div",
                      {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "ms-3", children: item.name })
                  ] })
                },
                item.id
              );
...
var Modal = ({
  ...
  let [isOpen, setIsOpen] = (0, import_react6.useState)(!!isOpenProp);
  function closeModal() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: `Modal ${containerClassName}`, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react7.Transition, { appear: true, show: isOpen, as: import_react6.Fragment, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "min-h-screen px-1 text-center md:px-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            import_react7.Transition.Child,
            {
              ...
              leaveTo: "opacity-0",
              children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react7.Dialog.Overlay, { className: "fixed inset-0 bg-neutral-900 bg-opacity-50 dark:bg-opacity-80" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            "span",
...
var Avatar = ({
  ...
  const [url, setUrl] = (0, import_react9.useState)(imgUrl);
...
var MySwitch = ({
  ...
  const [enabledState, setEnabledState] = (0, import_react10.useState)(false);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: "text-neutral-500 dark:text-neutral-400 text-base", children: desc })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
          import_react11.Switch,
          {
            ...
            className: `${enabledState ? "bg-blue-700" : "bg-neutral-400 dark:bg-neutral-6000"}
          relative inline-flex flex-shrink-0 ${switchSize} border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus-visible:ring-2  focus-visible:ring-white focus-visible:ring-opacity-75`,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "sr-only", children: label }),
...
var MyLink = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(import_link4.default, { className: `MyLink ${colorClass} ${className}`, href, children });
};
