    ...
    variants: {
        extend: {
            ...
            'custom-rte-styles-dark': [
                ...
                {
                    // .fabric-dark #rteTools .cm-s-default .cm-tag, .bootstrap5-dark #rteTools .cm-s-default .cm-tag, .material-dark #rteTools .cm-s-default .cm-tag, .tailwind-dark #rteTools .cm-s-default .cm-tag, .highcontrast #rteTools .cm-s-default .cm-tag
                    '.fabric-dark .control-pane .control-section .cm-s-default .cm-tag, .bootstrap5-dark .control-pane .control-section .cm-s-default .cm-tag, .material-dark .control-pane .control-section .cm-s-default .cm-tag, .tailwind-dark .control-pane .control-section .cm-s-default .cm-tag, .highcontrast .control-pane .control-section .cm-s-default .cm-tag':
                        {
                            color: '#00ff00',
                        },
                },
                ...
                {
                    // .fabric-dark #rteTools .cm-s-default .cm-attribute, .bootstrap5-dark #rteTools .cm-s-default .cm-attribute, .material-dark #rteTools .cm-s-default .cm-attribute, .tailwind-dark #rteTools .cm-s-default .cm-attribute, .highcontrast #rteTools .cm-s-default .cm-attribute
                    '.fabric-dark .control-pane .control-section .cm-s-default .cm-attribute, .bootstrap5-dark .control-pane .control-section .cm-s-default .cm-attribute, .material-dark .control-pane .control-section .cm-s-default .cm-attribute, .tailwind-dark .control-pane .control-section .cm-s-default .cm-attribute, .highcontrast .control-pane .control-section .cm-s-default .cm-attribute':
                        {
                            color: '#f00',
                        },
                },
                {
                    // .fabric-dark #rteTools .CodeMirror, .bootstrap5-dark #rteTools .CodeMirror, .material-dark #rteTools .CodeMirror, .tailwind-dark #rteTools .CodeMirror
                    '.fabric-dark .control-pane .control-section .CodeMirror, .bootstrap5-dark .control-pane .control-section .CodeMirror, .material-dark .control-pane .control-section .CodeMirror, .tailwind-dark .control-pane .control-section .CodeMirror':
                        {
                            background: '#303030',
                        },
                },
                {
                    // .highcontrast #rteTools .CodeMirror
                    '.highcontrast .control-pane .control-section .CodeMirror':
                        {
                            background: 'black',
                        },
                },
                ...
                {
                    // .fabric-dark .e-richtexteditor .e-rte-content .e-content pre, .bootstrap5-dark .e-richtexteditor .e-rte-content .e-content pre, .material-dark .e-richtexteditor .e-rte-content .e-content pre, .tailwind-dark .e-richtexteditor .e-rte-content .e-content pre, .highcontrast .e-richtexteditor .e-rte-content .e-content pre
                    '.fabric-dark .control-pane .control-section .e-richtexteditor .e-rte-content .e-content pre, .bootstrap5-dark .control-pane .control-section .e-richtexteditor .e-rte-content .e-content pre, .material-dark .control-pane .control-section .e-richtexteditor .e-rte-content .e-content pre, .tailwind-dark .control-pane .control-section .e-richtexteditor .e-rte-content .e-content pre, .highcontrast .control-pane .control-section .e-richtexteditor .e-rte-content .e-content pre':
                        {
                            padding: '10px',
                            background: '#303030',
                        },
